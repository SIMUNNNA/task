...
void initialize()
{
    ...
    window = SDL_CreateWindow("Snake Game by Adnan", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, SCREEN_WIDTH, SCREEN_HEIGHT, SDL_WINDOW_SHOWN);
    ...
    font = TTF_OpenFont("adnan.ttf", 24);
    if (!font)
    {
        cout << "Error:" << TTF_GetError() << endl;
        exit(0);
...
void render()
{
    ...
    TTF_Font *textFont = TTF_OpenFont("adnan.ttf", 70);
